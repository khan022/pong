...
function love.load()
    ...
    -- applying small sounds like hitting the paddle or scores.
    -- calling these entries from the table to play the sounds.
    sounds = {
...
function love.draw()
    ...
    love.graphics.clear(40/255, 45/255, 52/255, 240/255)
